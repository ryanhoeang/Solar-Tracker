...
int tilt_angle = 90;
int pan_angle = 90;
int adc_ratio = 3.3/4095; //actual voltage per adc value
void setup() {
////////////////////////////////////Pin Modes//////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  int solar_voltage = analogRead(solar_pin)*adc_ratio; //calculates actual voltage and print the values
  Serial.print("Solar Voltage: ");
  Serial.println(solar_voltage*2); //times 2 because of the voltage divider assembly.
